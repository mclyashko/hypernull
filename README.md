...
В данном репозитории предложено решение, использованное для бота Funny_Valentine, занявшего второе место в соревновании.

Решение базируется на алгоритме Ли и алгоритме обхода лабиринта.

Репозиторий содержит неисправленный серверный код. (Актуальная версия которого содержится в оригинальном проекте)
